use crate::{
    ...
    icon::Icon,
    platform_impl::platform::{util, Fullscreen},
...
use windows_sys::Win32::{
    ...
    UI::WindowsAndMessaging::{
        AdjustWindowRectEx, GetMenu, GetWindowLongW, SetWindowPos, GWL_EXSTYLE, GWL_STYLE,
        SWP_ASYNCWINDOWPOS, SWP_NOACTIVATE, SWP_NOMOVE, SWP_NOREPOSITION, SWP_NOZORDER, WINDOWPLACEMENT, WS_CAPTION, WS_SIZEBOX,
    },
};
...
impl WindowFlags {
    fn apply_diff(self, _window: HWND, _new: WindowFlags) {
    }
