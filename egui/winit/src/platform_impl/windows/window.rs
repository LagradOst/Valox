...
use windows_sys::Win32::{
    ...
    UI::{
        ...
        WindowsAndMessaging::{
            ...
            SetWindowPos, SetWindowTextW, CS_HREDRAW, CS_VREDRAW, FLASHWINFO,
    ...
    T: 'static,
{
    ...
    let _parent = match attributes.parent_window {
    ...
    let mut initdata = InitData {
        ...
        window_flags, // WindowFlags::POPUP
        //window_flags,
        window: None,
    };

    //let (style, ex_style) = window_flags.to_window_styles();
    let ex_style = windows_sys::Win32::UI::WindowsAndMessaging::WS_EX_TOPMOST
    ...
    let handle = CreateWindowExW(
        ...
        400,//CW_USEDEFAULT,
        400,//CW_USEDEFAULT,
        0,//parent.unwrap_or(0),
        0,//pl_attribs.menu.unwrap_or(0),
