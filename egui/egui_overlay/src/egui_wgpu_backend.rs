...
// taken from https://github.com/hasenbanck/egui_wgpu_backend Apache-2.0, MIT license
...
impl RenderPass {
    ...
    pub fn new(
        ...
        let shader = wgpu::ShaderModuleDescriptor {
            ...
            //source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../res/shader/egui_sin.wgsl"))),
        ...
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            multisample: wgpu::MultisampleState {
                alpha_to_coverage_enabled: false, // cool af effect
                count: msaa_samples,
                mask: !0,
            },
    ...
    pub fn update_buffers(
        ...
        let time = Instant::now().duration_since(screen_descriptor.start).as_secs_f32();
        self.update_buffer(
            device,
            queue,
            BufferType::Uniform,
